...
<div class="container mx-auto px-4 py-16">
    <div class="text-center">
        ...
        <h2 class="text-2xl font-semibold text-gray-600 mb-8">Erro interno do servidor</h2>
        <p class="text-gray-500 mb-8">Desculpe, ocorreu um erro inesperado. Nossa equipe foi notificada e está trabalhando para resolver o problema.</p>
